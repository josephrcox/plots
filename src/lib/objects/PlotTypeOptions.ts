...
export const options: PlotOption[] = [
  ...
  },
  {
    ...
    type: "medical",
    description:
      "Produces medicine from herbs and plants found in the forest. Increases health overall, but human testers for these herbs are expensive. Costs some gold every week.",
    revenue_per_week: 0,
    requirements: {
      gold: 600,
      plots: [],
    ...
    liege_on_plot_hint:
      "The apothecary is producing more medicine with your presence. You have a way of detecting the best herbs.",
  },
  {
    id: "livestock_farm",
    title: "🐄 Livestock",
  ...
  },
  {
    ...
    type: "tourism",
    description:
      "Enables tourism to your town, which increases revenue at stores.",
    revenue_per_week: 40,
    requirements: {
      gold: 4500,
      plots: [],
