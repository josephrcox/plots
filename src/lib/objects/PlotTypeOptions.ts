...
export const options: PlotOption[] = [
  ...
  },
  {
    ...
    type: "tourism",
    description:
      "Enables tourism to your town, which increases revenue at certain stores.",
    revenue_per_week: 23,
    requirements: {
      gold: 1500,
      plots: [],
  ...
  },
  {
    ...
    title: "☀️ Solar farm",
    type: "industrial",
    description: "Produces a lot of power without the need of water.",
    revenue_per_week: 0,
    requirements: {
      gold: 5000,
      plots: ["blacksmith"],
  ...
  },
  {
    ...
    revenue_per_week: 0,
    knowledge_points_per_month: 140,
    requirements: {
      gold: 50000,
  ...
  },
  {
    ...
    revenue_per_week: 0,
    knowledge_points_per_month: 100,
    requirements: {
      gold: 150000,
      plots: [],
      employees: 36,
